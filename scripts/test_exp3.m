%Script to run a set of experiment 3 simulations for both direct and indirect activation 
%hypotheses...
...
bakmcl1 = [];
activator = 'tBid';
[k, ic, names] = load_model(activator, 'reversible_exp4');
for T0 = T0list
	ic(2) = T0;
...
%colorbar();
saveplot(gcf, './images/demos/test_exp3-direct-tbid.eps');
...
ylabel('concentration (nM)');
%colorbar();
saveplot(gcf, './images/demos/test_exp3-direct-tbim.eps');
...
saveplot(gcf, './images/demos/test_exp3_final-direct-tbim.eps');
figure;
colormap([0 223/255 1; 1 207/255 0; 0.5 0 0]);
bar(1:7, obs_tbid');
ylim([0 12]);
...
legend('Multi. Bak', 'Bak*:Mcl-1', 'location', 'NorthWest');
set(gca,'XTickLabel',{'0.3','1','3','10','30', '100', '300'})
saveplot(gcf, './images/demos/test_exp3_final-direct-tbid.eps');
...
multibak = [];
activator = 'tBid';
[k, ic, names] = load_model(activator, 'reversible_exp4_indirect');
for T0 = T0list
	ic(2) = T0;
	conc = bcl2model(k, ic, names, t, T_p_none, activator);
	cytcc = [cytcc; conc(9,:)];
...
ylabel('concentration (nM)');
%colorbar();
saveplot(gcf, './images/demos/test_exp3-indirect-tbid.eps');
...
ylabel('concentration (nM)');
%colorbar();
saveplot(gcf, './images/demos/test_exp3-indirect-tbim.eps');
...
ylim([0 12]);
set(gca,'XTickLabel',{'0.3','1','3','10','30', '100', '300'})
saveplot(gcf, './images/demos/test_exp3_final-indirect-tbim.eps');
figure;
colormap([0 223/255 1; 1 207/255 0; 0.5 0 0]);
bar(1:7, obs_tbid');
ylim([0 12]);
...
legend('Multi. Bak', 'Bak*:Mcl-1', 'location', 'NorthWest');
set(gca,'XTickLabel',{'0.3','1','3','10','30', '100', '300'})
saveplot(gcf, './images/demos/test_exp3_final-indirect-tbid.eps');
