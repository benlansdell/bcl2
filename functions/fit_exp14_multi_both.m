function [fits r2 bakmcl1r2bid tbidmcl1r2 bakmcl1r2bim tbimmcl1r2] = fit_exp14_multi_both(x0, filename_tbim, filename_tbid, plotfit)
	...
	%
	% Usage:
	%			[fits, r2, bakmcl1r2bid, tbidmcl1r2, bakmcl1r2bim, tbimmcl1r2] = fit_exp14_multi_both(x0, filename_tbim, filename_tbid, plotfit)
	%
	% Input:
	%			x0 = initial parameters for k1a_tbim, k1a_tbid, k4a, k5a, k6a, k4d, k6d
	...
	%
	% Output:
	%			fits = vector of fitted values. In order: k1a_tbim, k1a_tbid, k4a, k5a, k6a, k4d, k6d
	...
	%
	% Example(s):
	%			[fits, r2, bakmcl1r2bid, tbidmcl1r2, bakmcl1r2bim, tbimmcl1r2] = fit_exp14_multi_both([-4 -4 -4 -4 -4 -4 -4], './images/test1', './images/test2');
	...
	ub = [-1, -1, -1, -1, -1, -1, -1];
	lb = [-6, -6, -6, -6, -6, -6, -6];
	tbim_params = [1 3 4 5 6 7];
	tbid_params = [2 3 4 5 6 7];
	...
	matlabpool 4;
	n_starts = 50;
	ms = MultiStart('TolX', 1e-4, 'MaxTime', 60000, 'Display', 'iter', 'UseParallel', 'always');
...
function [f, h1, h2, h3, h4, h5] = run_simulation(model, activator, T_p, t, x)
	%Start the system at equilibrium...
