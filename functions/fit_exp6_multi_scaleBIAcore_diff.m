function [fits r2 bakmcl1r2bid tbidmcl1r2 bakmcl1r2bim tbimmcl1r2] = fit_exp6_multi_scaleBIAcore(x0, filename_tbim, filename_tbid, plotfit)
	...
	%
	% Usage:
	%			[fits, r2, bakmcl1r2bid, tbidmcl1r2, bakmcl1r2bim, tbimmcl1r2] = fit_exp6_multi_scaleBIAcore(x0, filename_tbim, filename_tbid, plotfit)
	%
	% Input:
	...
	%
	% Example(s):
	%			[fits, r2, bakmcl1r2bid, tbidmcl1r2, bakmcl1r2bim, tbimmcl1r2] = fit_exp6_multi_scaleBIAcore([-6 -2 -4 -4 -4 -4 -4 0 0], './images/test1', './images/test2');
