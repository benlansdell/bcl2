function [fits r2 bakmcl1r2 tbimmcl1r2] = fit_exp4_multi_diff(x0, filename_tbim, filename_tbid, plotfit)
	...
	%
	% Usage:
	%			[fits, r2, bakmcl1r2, tbidmcl1r2] = fit_exp4_multi_diff(x0, filename_tbim, filename_tbid, plotfit)
	%
	% Input:
	...
	%
	% Example(s):
	%			[fits, r2, bakmcl1r2, tbidmcl1r2] = fit_exp4_multi_diff([-6 -2 -4 -4 -4 -4 -4 -6], './images/test1', './images/test2');
