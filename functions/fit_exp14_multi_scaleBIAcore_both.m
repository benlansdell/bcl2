function [fits r2 bakmcl1r2bid tbidmcl1r2 bakmcl1r2bim tbimmcl1r2] = fit_exp14_multi_scaleBIAcore_indirect(x0, filename_tbim, filename_tbid, plotfit)
	...
	%
	% Usage:
	%			[fits, r2, bakmcl1r2bid, tbidmcl1r2, bakmcl1r2bim, tbimmcl1r2] = fit_exp14_multi_scaleBIAcore_indirect(x0, filename_tbim, filename_tbid, plotfit)
	%
	% Input:
	%			x0 = initial parameters for k1a_tbim, k1a_tbid, k4a, k5a, k6a, k4d, k6d, D1, D2
	...
	%
	% Output:
	%			fits = vector of fitted values. In order: k1a_tbim, k1a_tbid, k4a, k5a, k6a, k4d, k6d, D1, D2
	...
	%
	% Example(s):
	%			[fits, r2, bakmcl1r2bid, tbidmcl1r2, bakmcl1r2bim, tbimmcl1r2] = fit_exp14_multi_scaleBIAcore([-4 -4 -4 -4 -4 -4 -4 0 0], './images/test1', './images/test2');
	
	observations = observations_exp14_multi();
	model = 'reversible_exp4_BIAcore_indirect';
	method = 'trust-region-reflective';

	ub = [-1, -1, -1, -1, -1, -1, -1, 3,  3];
	lb = [-6, -6, -6, -6, -6, -6, -6, -3, -3];
	tbim_params = [1 3 4 5 6 7 8 9];
	tbid_params = [2 3 4 5 6 7 8 9];
