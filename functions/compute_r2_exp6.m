function [r2, bakmcl1r2bid, tbidmcl1r2, bakmcl1r2bim, tbimmcl1r2] = compute_r2(observations, resnorm, f_tbid, f_tbim, time_points)
	...
	if (len(1) == 14)
		...
		throw(MException('ValueError:invalidObservation', 'Invalid observation matrix: must be provided by one of observations_exp6_multi()'));
	end
end