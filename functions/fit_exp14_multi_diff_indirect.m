function [fits r2 bakmcl1r2bid tbidmcl1r2 bakmcl1r2bim tbimmcl1r2] = fit_exp14_multi_diff_indirect(x0, filename_tbim, filename_tbid, plotfit)
	% fit_exp14_multi	Fit Experiment 6 quantitative observations to simulation results according to
	...
	%
	% Usage:
	%			[fits, r2, bakmcl1r2bid, tbidmcl1r2, bakmcl1r2bim, tbimmcl1r2] = fit_exp14_multi_diff_indirect(x0, filename_tbim, filename_tbid, plotfit)
	%
	% Input:
	...
	%
	% Example(s):
	%			[fits, r2, bakmcl1r2bid, tbidmcl1r2, bakmcl1r2bim, tbimmcl1r2] = fit_exp14_multi_diff([-4 -4 -4 -4 -4 -6], './images/test1', './images/test2');
