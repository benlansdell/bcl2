function [fits r2 bakmcl1r2bid tbidmcl1r2 bakmcl1r2bim tbimmcl1r2] = fit_exp6_multi_diff_both(x0, filename_tbim, filename_tbid, plotfit)
	...
	%
	% Usage:
	%			[fits, r2, bakmcl1r2bid, tbidmcl1r2, bakmcl1r2bim, tbimmcl1r2] = fit_exp6_multi_diff_both(x0, filename_tbim, filename_tbid, plotfit)
	%
	% Input:
	%			x0 = initial parameters for k1a_tbim, k1a_tbid, k4a, k5a, k6a, k4d, k6d, D
	...
	%
	% Output:
	%			fits = vector of fitted values. In order: k1a_tbim, k1a_tbid, k4a, k5a, k6a, k4d, k6d, D
	...
	%
	% Example(s):
	%			[fits, r2, bakmcl1r2bid, tbidmcl1r2, bakmcl1r2bim, tbimmcl1r2] = fit_exp6_multi_diff_both([-4 -4 -4 -4 -4 -4 -4 -6], './images/test1', './images/test2');
	...
	ub = [-1, -1, -1, -1, -1, -1, -1, -4];
	lb = [-6, -6, -6, -6, -6, -6, -6, -9];
	tbim_params = [1 3 4 5 6 7 8];
	tbid_params = [2 3 4 5 6 7 8];
