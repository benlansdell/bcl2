function [fits r2 bakmcl1r2bid tbidmcl1r2 bakmcl1r2bim tbimmcl1r2] = fit_exp14_multi_keepratios_indirect(x0, filename_tbim, filename_tbid, plotfit)
	% fit_exp4_multi	Fit Experiment 46 quantitative observations to simulation results according to
	...
	%
	% Usage:
	%			[fits, r2, bakmcl1r2, tbidmcl1r2] = fit_exp46_multi_keepratios_indirect(x0, filename_tbim, filename_tbid, plotfit)
	%
	% Input:
	...
	%
	% Example(s):
	%			[fits, r2, bakmcl1r2, tbidmcl1r2] = fit_exp46_multi_keepratios([-4 -4 -4 -4 -4 -4 -4 -4 -4 -4 -4 -4 -4], './images/test1', './images/test2');
