function [fits r2 bakmcl1r2bid tbidmcl1r2 bakmcl1r2bim tbimmcl1r2] = fit_exp14_multi_indirect(x0, filename_tbim, filename_tbid, plotfit)
	...
	%
	% Usage:
	%			[fits, r2, bakmcl1r2bid, tbidmcl1r2, bakmcl1r2bim, tbimmcl1r2] = fit_exp14_multi_indirect(x0, filename_tbim, filename_tbid, plotfit)
	%
	% Input:
	%			x0 = initial parameters for k4a, k5a, k6a, k4d, k6d
	...
	%
	% Output:
	%			fits = vector of fitted values. In order: k4a, k5a, k6a, k4d, k6d
	...
	%
	% Example(s):
	%			[fits, r2, bakmcl1r2bid, tbidmcl1r2, bakmcl1r2bim, tbimmcl1r2] = fit_exp14_multi([-4 -4 -4 -4 -4], './images/test1', './images/test2');
	...
	ub = [-1, -1, -1, -1, -1];
	lb = [-6, -6, -6, -6, -6];
	tbim_params = [1 2 3 4 5];
	tbid_params = [1 2 3 4 5];
